const products = [
  ...
  },
  {
    ...
    name: "Kateri Brinjal",
    image:
      "https://t4.ftcdn.net/jpg/00/69/19/09/360_F_69190946_dO9NYtUPGwAcKBR3pzeuwNkQy9bRCDbg.jpg",
    price: 43,
    description:
      "It has an elongated and cylindrical shape with an average of 2.5 to 4cm in diameter. About the taste, brinjal has a mild and slightly bitter taste when raw and changes to slightly sweet, earthy, and savory when cooked. As the name suggests, this brinjal is great for preparing Bharta.",
  },
  {
    id: 9,
